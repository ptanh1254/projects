        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <a href={`tel:${settings?.phone}`} className="text-blue-600 hover:text-blue-700">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <a href={`mailto:${settings?.email}`} className="text-blue-600 hover:text-blue-700 break-all">
              ...
              {/* Social Links Card */}
              {(settings?.facebookUrl || settings?.whatsappUrl || settings?.linkedinUrl || settings?.youtubeUrl) && (
                <Card>
                  <CardContent className="p-6">
