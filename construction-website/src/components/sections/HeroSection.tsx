    ...
    <section className="relative bg-gradient-to-br from-blue-600 to-blue-800 text-white overflow-hidden min-h-screen flex items-center">
      ...
      <Container className="relative w-full">
        <div className="max-w-4xl py-8 md:py-12">
            ...
            {/* Description */}
            <p
              className="text-lg md:text-xl lg:text-2xl text-white/95 mb-8 max-w-2xl leading-relaxed animate-slide-in-left"
            ...
            {/* CTA Buttons */}
            <div
              className="flex flex-col sm:flex-row gap-4 mb-12 animate-slide-in-left"
              style={{ animationDelay: '0.2s' }}
            >
              {currentSlideData.buttonText && currentSlideData.buttonLink && (
                <Link href={currentSlideData.buttonLink}>
                  <button className="px-8 py-3 bg-white text-blue-700 rounded-lg font-bold text-base shadow-2xl hover:shadow-3xl hover:bg-blue-50 transform hover:scale-105 transition-all duration-300">
                    {currentSlideData.buttonText}
                  </button>
                </Link>
              )}
              <Link href="/projects">
                <button className="px-8 py-3 bg-transparent border-2 border-white text-white rounded-lg font-bold text-base backdrop-blur-sm hover:bg-white hover:text-blue-700 transform hover:scale-105 transition-all duration-300 shadow-lg">
                  View Our Projects
                </button>
              </Link>
            </div>
            ...
            {/* Features */}
            <div
              className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl animate-fade-in"
            ...
            >
              <div className="flex items-center space-x-3 bg-white/5 backdrop-blur-sm rounded-lg p-3">
                ...
                <div>
                  <div className="font-semibold text-sm">Licensed & Insured</div>
                  <div className="text-xs text-blue-100">Fully certified</div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 bg-white/5 backdrop-blur-sm rounded-lg p-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-blue-100">98% success rate</div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 bg-white/5 backdrop-blur-sm rounded-lg p-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-blue-100">20+ years experience</div>
                </div>
              </div>
            </div>
          </div>
      ...
      {activeSlides.length > 1 && (
        <>
          ...
          <button
            onClick={prevSlide}
            className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:bg-white/20 transition-all z-10 shadow-lg"
          ...
          <button
            onClick={nextSlide}
            className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:bg-white/20 transition-all z-10 shadow-lg"
          ...
          {/* Dots Indicator */}
          <div className="absolute bottom-8 md:bottom-12 left-1/2 -translate-x-1/2 flex gap-2 z-10 bg-black/20 backdrop-blur-sm px-4 py-2 rounded-full">
